...
1. **Reporte Privadamente**
   - Use o recurso de [Security Advisories](https://github.com/rafaelakio/poc-n8n/security/advisories/new) do GitHub
...
- **GitHub Security**: [Security Advisories](https://github.com/rafaelakio/poc-n8n/security/advisories)

Para outras questões:
- **Issues**: [GitHub Issues](https://github.com/rafaelakio/poc-n8n/issues)
